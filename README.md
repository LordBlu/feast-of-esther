...
- **Production saves:** Connect **Vercel Blob** to the project (`BLOB_READ_WRITE_TOKEN`) — see **`ADMIN_GUIDE.md`**.
- **Agent / maintainer notes:** **`FUTURE_NOTES.md`** (latest features, env vars, handoff context).
