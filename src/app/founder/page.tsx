      ...
      */}
      <div className="relative h-[120vh] w-full md:h-[112vh]">
        <div className="sticky top-0 z-0 h-screen w-full">
          <FounderHero backgroundSrc={FOUNDER_HERO_CLOUDINARY} />
        </div>
      </div>
        ...
        <div className="foe-shell py-14 md:py-20">
          ...
          >
            <div className="mx-auto w-full max-w-3xl text-left text-[1.06rem] leading-[1.82] text-[#303845] md:text-[1.08rem]">
              ...
              <p>
                Pastor Mrs Folu Adeboye is the wife of the General Overseer of the Redeemed Christian Church of God
                (RCCG) Worldwide. She&apos;s a mother, a mentor, a teacher and a woman in the ministry. Over the years she
                has been noted for efficiency, effectiveness, excellency and balancing of roles.
              </p>
              
              <p>
                In 1981, Pastor Mrs. Adeboye took up the Children Sunday School with a few teachers. She wrote the Sunday
                school manual now known as Zeal from 1981–1999. Presently, Teachers&apos; Conferences are hosted annually
                to give teachers induction and charge them for the task ahead as the work grows stronger daily.
              </p>
              
              <p>
                In 1981, Pastor E. A. Adeboye set the pace for the establishment of the formal educational arm of CRM.
                Mummy G.O., armed with her 15 years of teaching experience, took up the challenge. Today, there are over
                fifty-eight nursery/primary schools in twenty-three states in Nigeria, over six RCCG secondary schools, one
                science academy, and the Redeemers University for Nations (RUN). Pastor (Mrs.) Folu Adeboye continues to
                serve in leadership across these institutions.
              </p>
              </div>
            </div>
