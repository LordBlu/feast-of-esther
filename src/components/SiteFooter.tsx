...
import brand from './BrandLockup.module.css';
...
export default function SiteFooter() {
  ...
  return (
    <footer className="mt-auto bg-[#1a1a1a] px-4 py-12 text-center text-white">
      <div className={styles.footerBrandSlot}>
        <Link href="/" className={brand.wrapDark}>
          <span className={brand.titleDark}>Feast of Esther</span>
          <span className={brand.tagline}>North America</span>
        </Link>
      </div>
      <p className="mb-4 text-sm font-medium tracking-wide" style={{ fontFamily: 'var(--font-body)' }}>
        Follow Us:
      </p>
      ...
      <p className="text-xs text-white/70" style={{ fontFamily: 'var(--font-body)' }}>
        Copyright {year} © FeastOfEstherNA
      </p>
    </footer>
  );
}
